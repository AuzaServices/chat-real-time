document.addEventListener("DOMContentLoaded", function () {
  ...
  const selectedName = decodeURIComponent(params.get("name") || "").trim();
    ...
    window.professionals = [
        ...
        { id: 175, service: "AuzaPoli (Polivalentes)", name: "Francisco Oliveira", age: 45, city: "Horizonte - CE", stars: "⭐⭐⭐", comment: "Conserto e instalação de motores elétricos e poços", whatsapp: "5585991760052" , imagens: [ "https://i.imgur.com/X2ILycP.jpeg", "https://i.imgur.com/GkQhSzq.jpeg" ]},
        { id: 177, service: "AuzaPoli (Polivalentes)", name: "Andrey Lima", age: 27, city: "Horizonte - CE", stars: "⭐⭐⭐", comment: "Logistica, Servente, Ajudante de Pintor e Motorista", whatsapp: "5585991275239"},
        //Pedreiro
